...
#from kymatio.datasets import fetch_fsdd                   D:\Kymatio\Dataset\multitracks


def find_datasets_base_dir(datasets_base_dir='D:/Kymatio/'):
    """
...
def get_dataset_dir(dataset_name, datasets_base_dir='D:/Kymatio/', create=True):
    """
...
def get_dataset(verbose=False):
    ...
    dictionary: dictionary
        ...
        ending with .wav
    """
    path = get_dataset_dir("Dataset")
    repo = os.path.join(path, 'multitracks')
